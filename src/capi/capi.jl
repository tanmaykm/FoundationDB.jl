module CApi
    ...
    export FDBFuture, FDBCallback, FDBDatabase, FDBTransaction
    export fdb_select_api_version_impl, fdb_select_api_version, fdb_get_max_api_version, fdb_get_client_version, fdb_network_set_option, fdb_setup_network,
            ...
            fdb_future_is_ready, fdb_future_set_callback, fdb_future_release_memory, fdb_future_get_error, fdb_future_is_error, fdb_future_get_keyvalue_array,
            ...
            fdb_transaction_get_range, fdb_transaction_get_range_selector, fdb_get_error, fdb_error_predicate
